...
void RTC_clk_config(void){
	...
	/*4.Select the RTC clock source  to LSE by setting RTCSEL in RCC_BDCR register*/
	RCC->BDCR |= RCC_BDCR_RTCSEL_LSE;

	/*5.Enable LSE by setting LSEON bit in the RCC_BDCR register*/
	/*Enable LSE*/
	RCC->BDCR |= RCC_BDCR_LSEON;

	/*Wait until the LSEON bit is set completely*/
